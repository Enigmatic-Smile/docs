...
<tbody>
    <tr>
        ...
        <td>function</td>
        <td>Function to be called when a Card is enrolled successfully. Receives the Card entity as argument.</td>
    </tr>
    <tr>
    ...
    <tr>
        <td><code>onCardVerificationStartedCallback</code></td>
        <td>function</td>
        <td>Function to be called when a Card verification starts. Receives an object with consentId as argument.</td>
    </tr>
    <tr>
        <td><code>onCardVerifiedCallback</code></td>
        <td>function</td>
        <td>Function to be called when a Card is verified successfully. Receives an object with cardId as argument.</td>
    </tr>
    <tr>

...
<div class="info-box">
    ...
    To confirm receipt of a webhook event, your server endpoint should return a <code>200 OK</code> HTTP status code. Any other response will be treated as a failure and the Fidel API will retry sending requests three times over the next hour with exponential delays between retries.
</div>

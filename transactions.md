...
| `identifiers.mastercardRefNumber` | Unique identifier of the transaction provided by Mastercard. This is used by Fidel API to try to match a given clearing transaction with the corresponding authorization transaction. | string (or null) |

...
| identifiers.amexApprovalCode | Unique code that is sent along with the authorization of the transaction by Amex. It mirrors the approvalCode property. | string (or null) |

...
Reimbursement supports both debit and credits cards by Visa, Mastercard and American Express in the US. Your account must be setup in the US to have access to the Reimbursement product.
...
- Transaction `scheme` is `visa`, `mastercard` or `amex`;

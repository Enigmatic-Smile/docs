...
<tbody>
  ...
  <tr>
    ...
    <td>function</td>
    <td>Function to be called when a Card is enrolled successfuly. Receives the [Card entity](#card-entity) as argument.</td>
  </tr>
  <tr>
    <td><code>onCardEnrollFailedCallback</code></td>
    <td>function</td>
    <td>Function to be called when a Card enrollment fails. Receives an error object as argument.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>function</td>
    <td>Function to be called when a Card verification fails. Receives an error object as argument including the cardId.</td>
  </tr>
  <tr>
...
<tbody>
  <tr>
    <td><code>id</code></td>
    <td>string</td>
    <td>ID of the enrolled card</td>
  </tr>
  <tr>
    <td><code>accountId</code></td>
    <td>string</td>
    <td>Account ID of the program where the card was enrolled</td>
  </tr>
  <tr>
    <td><code>programId</code></td>
    <td>string</td>
    <td>ID of the program where the card was enrolled</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>number</td>
    <td>Last 4 numbers of the card</td>
  </tr>
  <tr>
    <td><code>firstNumbers</code></td>
    <td>number</td>
    <td>First 6 numbers of the card</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><code>expYear</code></td>
    <td>Number</td>
    <td>Expiration year of the card</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>String</td>
    <td>Expiration date (MM/YY format)</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><code>metadata</code></td>
    <td>Object</td>
    <td>Returns the metadata set by the enrollment API call</td>
  </tr>
</tbody>
</table>
...
<tbody>
  <tr>
    ...
    <td>ID of the enrolled card. Might not be present if card is not enrolled at the error stage</td>
  </tr>
  <tr>
    <td><code>date</code></td>
    <td>string</td>
    <td>Date when the error happened</td>
  </tr>
  <tr>
    <td><code>type</code></td>
    <td>string</td>
    <td>Returns the error [code](#error-codes)</td>
  </tr>
  <tr>

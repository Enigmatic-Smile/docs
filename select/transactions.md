...
| `approvalCode` | Unique code that is sent along with the authorization of the transaction for some network transactions. | string (or null) |
...
| `card.firstNumbers`                 | The first numbers of the card, used for helping users identify their cards (Visa or Mastercard).                                                                                                                                                                                                                                    | string                                                                                              |

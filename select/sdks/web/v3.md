# Web SDK <a style={{'color': '#111'}} className="improve-docs" href="/select/sdks/web/v2">v2</a> <a style={{'margin-right': 'auto', 'border-bottom': '2px solid #0048ff'}} className="improve-docs" href="/select/sdks/web/v3">v3</a>
...
<tbody>
  ...
  <tr>
    ...
    <td>function</td>
    <td>Function to be called when the user cancels the card enrollment with one of the following actions: <br /> - Closing the window with the "x" in the top right corner <br /> - Clicking/tapping outside the SDK's frame <br /> - Pressing the ESC key on the keyboard <br /> No arguments are provided.</td>
  </tr>
  <tr>
...
<tbody>
  ...
  <tr>
    ...
    <td>string<br /> <em>Possible values: form | overlay | none</em><br /> <em>Default value: overlay</em></td>
  ...
  <tr>
    ...
    <td>string<br /> <em>Default value: "Connect your card"</em></td>
  ...
  <tr>
    ...
    <td>string<br /> <em>Default value: "I authorize &#123;&#123;scheme&#125;&#125; to monitor my payment card to identify transactions that qualify for a reward and for &#123;&#123;scheme&#125;&#125; to share such information with &#123;&#123;companyName&#125;&#125;, to enable my card linked offers and target offers that may be of interest to me."</em></td>
  ...
  <tr>
    ...
    <td>string<br /> <em>Default value: "going to your account settings"</em></td>
  ...
  <tr>
    ...
    <td>CSS properties<br /></td>
    <td>The styles of the terms text.</td>
  </tr>
  <tr>
    <td><code>terms.urlStyle</code></td>
    <td>CSS properties<br /></td>
    <td>The styles of the URLs (anchor elements) included within the terms text.</td>
  </tr>
  <tr>
    <td><code>terms.checkbox</code></td>
    <td><code>style</code>: CSS properties<br /> <code>checkedStyle</code>: CSS properties</td>
  ...
  <tr>
    ...
    <td><code>style</code>: CSS properties<br /> <code>hoverStyle</code>: CSS properties<br /> <code>loadingStyle</code>: CSS properties<br /> <code>successStyle</code>: CSS properties<br /> <code>defaultText</code>: string<br /> <em>Default value: "Continue"</em><br /> <code>loadingText</code>: string<br /> <code>successText</code>: string</td>
  </tr>
</tbody>
</table>

...
The SDK provides a pre-built UI that allows you to easily collect credit card details, tokenise and link credit/debit cards with rewards services from your website, e-commerce platform or mobile web apps. However, for mobile apps, we recommend using the [Fidel Mobile SDKs](/select/sdks/ios/guide).
...
<tbody>
  ...
  <tr>
    ...
    <td>string</td>
    <td>A valid SDK Key. You can find yours on the <a href="https://dashboard.fidel.uk/account/plan">Dashboard</a>. It starts with "pk_". For security reasons, please do not store the SDK Key in your codebase. Follow our [SDK security guide](/docs/stream/sdks/sdk-security-guidelines) for detailed recommendations.</td>
  </tr>
  <tr>

# Web SDK <a style={{borderBottom: '2px solid #0048ff'}} className="improve-docs" href="/select/sdks/web/v2">v2</a> <a style={{marginRight: 'auto', 'color': '#111'}} className="improve-docs" href="/select/sdks/web/v3">v3</a>

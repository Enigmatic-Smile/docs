...
- Download the latest version of the `Fidel.xcframework` and `analytics.xcframework` artifacts from the `master` branch of our [GitHub repo](https://github.com/FidelLimited/fidel-ios).

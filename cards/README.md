...
![Fidel Dashboard Create Card](https://raw.githubusercontent.com/FidelLimited/docs/new-dashboard-images/assets/images/dashboard-new-card.gif "Fidel Dashboard Create Card")
...
![API Playground Create Card](https://raw.githubusercontent.com/FidelLimited/docs/new-dashboard-images/assets/images/dashboard-create-card.gif "API Playground Create Card")
